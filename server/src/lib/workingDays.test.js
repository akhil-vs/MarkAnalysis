...
describe("workingDays", () => {
  ...
  it("accepts a valid 5-day or 6-day set and sorts uniquely", () => {
    assert.deepEqual(normalizeWorkingDays([5, 1, 2, 3, 4, 1]), FIVE_DAY_WORKING_DAYS);
    assert.deepEqual(normalizeWorkingDays([6, 5, 4, 3, 2, 1]), DEFAULT_WORKING_DAYS);
  });

  it("parses patches and rejects wrong counts", () => {
