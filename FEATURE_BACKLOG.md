...
- ~~**Teacher leave requests + role-access approval / substitutes**~~ (teachers request from dashboard; `leaveApproval` / `assignSubstitutes` in Staff → Role access; stakeholders notified; approved leave overlays timetables)
