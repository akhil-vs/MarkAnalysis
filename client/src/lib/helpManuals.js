...
export const HELP_MANUALS = [
  {
    ...
    audience: "Principals",
    body: "School setup, staff access, leave and cover, mark approval, leadership analytics, and board-facing outputs.",
  ...
  },
  {
    ...
    body: "Exam operations: records, chase-ups, mark entry and approval, leave cover, consolidated lists, and hall tickets.",
  ...
  },
  {
    ...
    audience: "Teachers",
    body: "Sign-up, mark entry and bulk upload, leave requests, notices, class-teacher lists, hall tickets, and your desk.",
