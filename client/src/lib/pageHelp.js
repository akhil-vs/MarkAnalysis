...
export const PAGE_HELP = {
  ...
  timetables: {
    ...
    useful: "Expand a teacher on the Teachers tab to open their weekly timetable, put them on leave, or review hrs history for the current week (own teaching plus extra cover hours). Use Previous week and Next week to load one week at a time. Teachers request leave from their dashboard; roles with Leave approval confirm it under Leave & cover so vacated periods show on the daily board. Assign substitutes (role access) to place ranked cover. Cover periods appear as extra hours on the substitute’s daily board row and in Hours history. Enable Leave approval and Assign substitutes under Staff → Role access for vice principals, supervisors, and coordinators.",
  },
  schoolProfile: {
    title: "What's on this page",
