...
export const PAGE_HELP = {
  ...
  timetables: {
    title: "What's on this page",
    about: "Teacher schedules, the all-staff daily board, a free-period finder, and leave with balanced substitute cover. Open a teacher for daily/weekly grids or hours history (classes, taught hours, and extra cover hours by day).",
