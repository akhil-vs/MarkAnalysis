...
export const PAGE_HELP = {
  ...
  hallTickets: {
    ...
    useful: "Pick an exam, then a class and division. Preview loads on the right; use Download PDF (or the PDF button beside each division) to print. Create/save a batch to store title, venue, and instructions. Upload student photos under Student photos. Paper dates and start times come from Records → Exams — if one class timetable is done, leadership can copy it to the other classes.",
  },
  studentPhotos: {
    title: "What's on this page",
